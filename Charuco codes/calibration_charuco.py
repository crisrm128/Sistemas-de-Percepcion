...
calib_info = dict = {'mtx':cameraMatrix, 'dist':distCoeffs,'rvecs':rvecs,'tvecs':tvecs}

np.savez('calib_charuco_parameters.npz', **calib_info)  # data is a dict here
    
# Print to console our success
print('Calibration successful. Calibration file used: {}'.format('calib_charuco_parameters.npz'))